...
// if (isAdmin == false) // explicitly checks for false
// if (!isAdmin) // checks falsy value (undefined, null, false, etc.)             
                    <>
                        ...
                        <div className='px-[100px]'>
                            ...
                            <form onSubmit={submitForm}>
                                ...
                                <input type="file" className='my-3 file:mr-4 file:py-2 file:px-4 file:rounded-md  file:text-sm file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700' onChange={(e) => { setImage(e.target.files[0]) }} id='file' /> <br />
